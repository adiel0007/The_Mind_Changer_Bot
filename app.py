...
# 🛠️ עדכון: הפונקציה מריצה כעת סינון ממוקד לפי ה-mode הנבחר (long / short)
...
# 🛠️ עדכון: פיצול משתני הסטטוס להבטחת עצמאות מוחלטת בין הטאבים
...
with tab1:
    ...
    # 🛠️ כפתור ייעודי פנימי לרדאר שורט בלבד
...
with tab2:
    ...
    # 🛠️ כפתור ייעודי פנימי לרדאר לונג בלבד
